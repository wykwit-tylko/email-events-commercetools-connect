...
export async function handleQueue(batch: MessageBatch<QueuePayload>, env: Env): Promise<void> {
...
async function handleQueueMessage(message: Message<CommerceNotification>, env: Env): Promise<void> {
